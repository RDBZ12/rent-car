...
<div class="d-flex align-items-center justify-content-start mb-4">
    <button class="btn btn-primary shadow-sm me-3" type="button" onclick="frmTipo();">
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <div class="table-responsive">
            <table class="table table-hover display responsive nowrap" id="tblTipos" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Estado</th>
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <form id="formulario" onsubmit="registrarTipo(event);" autocomplete="off">
                <div class="modal-body p-4 pt-1">
                    <div class="mb-3">
                        <label for="nombre" class="form-label small fw-bold mb-1"><i class="fas fa-tag text-primary me-1"></i> Nombre del Tipo *</label>
                        <input type="hidden" id="id" name="id">
                        <input id="nombre" class="form-control shadow-none border-2" type="text" name="nombre" placeholder="Ej: Normal / Feriado" required>
                    </div>
                    ...
                    <div class="mt-3 p-2 bg-light rounded border border-2 border-primary border-opacity-10">
                        <div class="form-check form-switch d-flex align-items-center justify-content-center">
                            ...
                            <label class="form-check-label fw-bold text-dark ms-3 mb-0 small" for="estado" style="cursor: pointer; letter-spacing: 0.5px;">ESTADO DEL TIPO (ACTIVO)</label>
                        </div>
                    </div>
                </div>
